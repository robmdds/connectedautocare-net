                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-white rounded-lg shadow-xl p-8 text-gray-900 border-4 border-blue-600">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-lg text-gray-800 font-semibold">Complete form for accurate pricing and coverage options</p>
                            </div>
                                ...
                                <form onSubmit={handleQuoteSubmit} className="space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            className={`text-xl font-mono tracking-wider h-14 ${vinError ? 'border-red-500' : 'border-blue-300 focus:border-blue-500'}`}
                                            maxLength={17}
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            className={`text-xl h-14 ${mileageError ? 'border-red-500' : 'border-blue-300 focus:border-blue-500'}`}
                                            min="0"
                                            max="500000"
                                        ...
                                        <p className="text-sm text-blue-700">Required for accurate coverage eligibility and pricing</p>
                                    </div>
                                    ...
                                    <div className="border-t border-blue-200 pt-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <Input
                                                    ...
                                                    className={`text-lg h-12 ${nameError ? 'border-red-500' : 'border-blue-300 focus:border-blue-500'}`}
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <Input
                                                    ...
                                                    className={`text-lg h-12 ${zipcodeError ? 'border-red-500' : 'border-blue-300 focus:border-blue-500'}`}
                                                    maxLength={10}
                                        ...
                                        <div className="space-y-3 mt-4">
                                            ...
                                            <Input
                                                ...
                                                className={`text-lg h-12 ${emailError ? 'border-red-500' : 'border-blue-300 focus:border-blue-500'}`}
